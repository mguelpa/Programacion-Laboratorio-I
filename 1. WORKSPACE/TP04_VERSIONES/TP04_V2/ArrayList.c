 ...
 * \param  (void).
 *
 * \return  if ok     pointer to new arrayList
 *          if Error [can't allocate memory]
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief  Returns an array containing all of the elements in pList
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief Returns a new arrayList with a portion of pList between the
 ...
 *
 * \return (NULL) if Error [pList is NULL pointer]
 *                         [invalid 'from' or invalid 'to']
 ...
 * \param  pElement void* Pointer to element
 *
 * \return (-1) if Error [pList or pElement are NULL pointer or invalid index]
 *         ( 0) if Ok.
 */
 ...
 * \param  pElement void* Pointer to element
 *
 * \return (-1) if Error [pList or pElement are NULL or invalid index]
 *         ( 0) if Ok
 */
 ...
 * \param  index int Index of the element
 *
 * \return (-1) if Error [pList is NULL pointer or invalid index]
 *         ( 0) if Ok
 */
 ...
 * \param  pList ArrayList* Pointer to arrayList.
 *
 * \return (-1) if Error [pList is NULL pointer]
 *         ( 0) if Ok.
 */
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief Returns the index of the first occurrence of the specified
 *        element.
 *
 * \param pList ArrayList* Pointer to arrayList
 * \param pElement void* Pointer to element
 *
 * \return (-1) if Error [pList or pElement are NULL pointer]
 ...
 * \param  index int Index of the element
 *
 * \return (NULL) if Error [pList is NULL pointer or invalid index]
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief Remove the item at the given position in the list, and
 *        return it.
 *
 * \param pList ArrayList* Pointer to arrayList
 * \param index int Index of the element
 ...
 *                    ( 1) if pList list contains at least one
 *                         element pElement
 */
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief  Returns true if pList list contains all of the elements of
 *		   pList2.
 * \param  pList  ArrayList* Pointer to arrayList
 * \param  pList2 ArrayList* Pointer to arrayList
 *
 * \return (-1) if Error [pList or pList2 are NULL pointer]
 ...
 *
 * \param  pList ArrayList* Pointer to arrayList
 * \param  pFunc (*pFunc) Pointer to fuction to compare elements of
 *         arrayList.
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief  Increment the number of elements in pList in AL_INCREMENT
 *         elements.
 * \param  pList ArrayList* Pointer to arrayList
 *
 * \return (-1) if Error [pList is NULL pointer or can't allocate]
 *         ( 0) if ok
 */
    int resizeUp ( ArrayList* this )
    {
...
//////////////////////////////////////////////////////////////////////
/*********************************************************************
 * \brief  Decrement the number of elements in this in AL_INCREMENT
 *         elements.
 * \param  pList ArrayList* Pointer to arrayList
 *
 * \return (-1) if Error [pList is NULL pointer or can't allocate]
...
void al_debugShow ( ArrayList* this )
{
    ...
    for(i=0; i < this->size; i++)
    {
    	printf("void** *(pElements+%d): %p de %d\n", i, *(this->pElements+i), this->size);
        //printf("%p numero %d de %d\n", *(this->pElements+i), i, this->size);
    }
}
//////////////////////////////////////////////////////////////////////
void al_hardCode ( ArrayList* this )
{
    int i;
    for(i=0; i < this->size; i++)
    {
