...
int input_getAnumericStr (char* request, char* errorMsg, int attemps, int min, int max, char* target)
{
    ...
    do
    {
        input_fgetsSwitchLF(request, auxStr, 256, stdin);
...
////////////////////////////////////////////////////////////////////////////////
int input_getString (char* request, char* errorMsg, int attemps, int min, int max, char* target)
{
    int retorno = -1;
    char auxStr[256];
...
////////////////////////////////////////////////////////////////////////////////
int valid_verifyString (char* str)
{
   int i=0;
   while(str[i] != '\0')
   {
...
// int input_getCuitStr (char* request, char* errorMsg, int attemps, int min, int max, char* target)
// {
//     int retorno = -1;
//     char auxStr[256];
...
//     {
//         input_fgetsSwitchLF(request, auxStr, 256, stdin);
//         retorno = valid_verifyCuit (auxStr);
//         switch (retorno)
//         {
//             case -1:
//                 if(i < attemps)
...
// int valid_verifyCuit(char* buffer)
// {
//     int i=0;
//     int retorno = 0;
//     int flagGuion = 0;
