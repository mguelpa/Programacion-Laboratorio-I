...
void cliente_imprimir(void* pCliente)
{
    ...
    if(cliente_getClientStatus(pCliente) != CLIENTE_ESTADO_BAJA)
    {
        printf("------------------------------\n");
        printf("id cliente: %d\n", cliente_getClientID(pCliente));
        printf("estatus: %d\n", cliente_getClientStatus(pCliente));
        printf("nombre: %s\n", cliente_getNombre(pCliente));
        printf("apellido: %s\n", cliente_getApellido(pCliente));
        printf("dni: %s\n", cliente_getDni(pCliente));
        printf("------------------------------\n\n");
    }
}
