...
int sub_hardCode (ArrayList* list)
{
    ...
    char name [10][MAX_CHAR_NAMES] = {"maxi", "ana", "ale", "oski", "viky", "euge", "tomy", "martin", "pablo", "lean"};
    char surname [10][MAX_CHAR_NAMES] = {"maxi", "ana", "ale", "oski", "viky", "euge", "tomy", "martin", "pablo", "lean"};
...
void sub_debugShow (ArrayList* list)
{
    ...
    for(i=0; i<al_len(list); i++)
    {
        ...
        printf("name: %s\n", sub_getName(auxiliar));
        printf("surname: %s\n\n", sub_getSurname(auxiliar));
